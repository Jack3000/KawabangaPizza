class PizzasController < ApplicationController
  ...
  # POST /pizzas.json
  def create
    true_params = pizza_params
    if params[:toppings]
      true_params[:toppings] = params[:toppings].join(", ")
    else
      true_params[:toppings] = "None."
    end
    @pizza = Pizza.new(true_params)
  ...
  private
    ...
    def pizza_params
      params.require(:pizza).permit(:name, :doe_kind, :toppings, pizza_pics_attributes: [:id, :pic_num, :image])
    end
end
